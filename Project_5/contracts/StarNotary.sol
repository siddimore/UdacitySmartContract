...
contract StarNotary is ERC721{
    ...
    string public constant name = "STAR Labs!!";
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        Star memory retStar = tokenIdToStarInfo[_tokenId]; // Creating in memory the Star -> tokenId mapping
        return retStar.name;
    }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        // validate owner1 == msg.sender
        require(ownerOf(_tokenId) == msg.sender, "Verify Owner1 is the sender");
        // transfer token from owner1 to owner2
